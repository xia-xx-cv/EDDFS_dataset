...
import models.baseline.tools.layer as layers
...
from models.baseline.tools.layer import conv1x1, DropPath
from models.baseline.tools.attentions import Attention2d
...
class LocalAttention(nn.Module):
    ...
    def forward(self, x, mask=None):
        ...
        mask = mask + self.pos_embedding[self.rel_index[:, :, 0].numpy(), self.rel_index[:, :, 1].numpy()]
