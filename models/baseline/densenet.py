...
model_weight_paths = {
    "densenet121": "pre-trained/densenet/densenet121-a639ec97.pth",
    "densenet169": "pre-trained/densenet/densenet169-b2777c0a.pth",
    "densenet201": "pre-trained/densenet/densenet201-c1103571.pth",
    "densenet161": "pre-trained/densenet/densenet161-8d451a50.pth"
}
...
def densenet121(pretrained=True, **kwargs: Any) -> DenseNet:
    # Top-1 error: 25.35%
    ...
    model = DenseNet(growth_rate=32,
                    ...
                    **kwargs)
    if pretrained:
        load_state_dict(model, model_weight_paths["densenet121"])
    return model


def densenet169(pretrained=True, **kwargs: Any) -> DenseNet:
    # Top-1 error: 24.00%
    ...
    model = DenseNet(growth_rate=32,
                    ...
                    **kwargs)
    if pretrained:
        load_state_dict(model, model_weight_paths["densenet169"])
    return model


def densenet201(pretrained=True, **kwargs: Any) -> DenseNet:
    # Top-1 error: 22.80%
    ...
    model = DenseNet(growth_rate=32,
                    ...
                    **kwargs)
    if pretrained:
        load_state_dict(model, model_weight_paths["densenet201"])
    return model

def densenet161(pretrained=True, **kwargs: Any) -> DenseNet:
    # Top-1 error: 22.35%
    ...
    model = DenseNet(growth_rate=48,
                    ...
                    **kwargs)
    if pretrained:
        load_state_dict(model, model_weight_paths["densenet161"])
    return model
